...
/**
 * Curba\GardeningBundle\Entity\LifeCicleType
 *
 * @ORM\Table()
 * @ORM\Entity
 */
class LifeCicleType implements \Gedmo\Translatable\Translatable
{
    /**
     * @var integer $id
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="Plant", mappedBy="life_cicle_type")
     */
    private $plants;
