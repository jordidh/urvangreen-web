...
/**
 * Curba\GardeningBundle\Entity\ClimateType
 *
 * @ORM\Table()
 * @ORM\Entity
 */
class ClimateType implements \Gedmo\Translatable\Translatable
{
    /**
     * @var integer $id
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="Plant", mappedBy="climate_type")
     */
    private $plants;
