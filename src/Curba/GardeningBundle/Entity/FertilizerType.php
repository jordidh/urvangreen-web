...
/**
 * Curba\GardeningBundle\Entity\FertilizerType
 *
 * @ORM\Table()
 * @ORM\Entity
 */
class FertilizerType implements \Gedmo\Translatable\Translatable
{
    /**
     * @var integer $id
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="Plant", mappedBy="fertilizer_type")
     */
    private $plants;
