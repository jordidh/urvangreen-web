...
/**
 * Curba\GardeningBundle\Entity\FrostResistanceType
 *
 * @ORM\Table()
 * @ORM\Entity
 */
class FrostResistanceType implements \Gedmo\Translatable\Translatable
{
    /**
     * @var integer $id
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="Plant", mappedBy="frost_resistance_type")
     */
    private $plants;
