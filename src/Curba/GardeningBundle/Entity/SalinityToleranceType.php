...
/**
 * Curba\GardeningBundle\Entity\SalinityToleranceType
 *
 * @ORM\Table()
 * @ORM\Entity
 */
class SalinityToleranceType implements \Gedmo\Translatable\Translatable
{
    /**
     * @var integer $id
     *
    ...
    /**
     * @ORM\OneToMany(targetEntity="Plant", mappedBy="salinity_tolerance_type")
     */
    private $plants;
